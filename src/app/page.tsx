    ...
    return (
      <div className="container flex flex-col items-center justify-center py-10 text-center">
        <Card className="w-full max-w-lg">
            <CardHeader>
                <CardTitle className="text-3xl font-bold">Welcome to EquiProgress!</CardTitle>
                <CardDescription>
                Track your horse training sessions, monitor progress, and achieve your equestrian goals.
                </CardDescription>
            </CardHeader>
